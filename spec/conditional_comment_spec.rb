...
describe "conditional comments" do
  ...
  it "transforms DANG conditional comment closers with whitespace into HTML conditional comment closers" do
    Dang.it("<!      [end]    !>").must_equal "<![endif]-->"
  end
  ...
  # it "transforms NOT IE one line DANG conditional comments into one line HTML conditional comments" do
  #   Dang.it("<! [if !IE] !>...<! [end] !>").must_equal "<!--[if !IE]>...<![endif]-->"
  # end
